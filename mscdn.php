...
<meta charset="UTF-8">
    ...
    <script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"
     ...
     <link rel="stylesheet" href="mscdn.css">
...
<body>
    ...
    <a href="gotowe.php" class="powrot">Powrót</a>
    <div class="grid-container">
        <div class="grid-child-green">
            <?php

            $obiekty = array(array('i', 'MSCDN'), array('b', 'Biblioteka na Koszykowej'), array('b', 'Biblioteka Narodowa'),                 array('b', 'Biblioteka UW'), array('b', 'Biblioteka Bemowo'), array('b', 'Biblioteka Białołęka'),
