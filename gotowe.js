...
var mscdn = L.circle([52.250450, 21.006320], {
    color: 'red',
    fillColor: '#1fb827',
    fillOpacity: 0.9,
    radius: 80,
...
obiekty = [['i', 'MSCDN'], ['b', 'Biblioteka na Koszykowej'], ['b', 'Biblioteka Narodowa'], 
...
mscdn.on('dblclick', function(){
    location.href = 'mscdn.php';
})
